...
docker tag keboola/logspout:$VERSION 147946154733.dkr.ecr.us-east-1.amazonaws.com/keboola/logspout:latest
docker push 147946154733.dkr.ecr.us-east-1.amazonaws.com/keboola/logspout:latest
docker tag keboola/logspout:$VERSION 147946154733.dkr.ecr.us-east-1.amazonaws.com/keboola/logspout:$TRAVIS_COMMIT
